...
class BaremetalRAGBackend:
    def complete(self, prompt: str):
        """Directly call the LLM for completion."""
        return Settings.llm.complete(prompt)
    def __init__(self, ovms_url="http://localhost:8005/v3", model_name="OpenVINO/TinyLlama-1.1B-Chat-v1.0-int8-ov", embed_model="BAAI/bge-base-en-v1.5", system_prompt=None):
    ...
    # Connection and model availability checks removed for direct chat connection to 8005
